 ...
 */
public class FrmAddEmprestimoMenuEstudante extends javax.swing.JFrame {
    ...
    public FrmAddEmprestimoMenuEstudante(String txt) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAddEmprestimoMenuEstudante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAddEmprestimoMenuEstudante("").setVisible(true);
            }
        });
    }
