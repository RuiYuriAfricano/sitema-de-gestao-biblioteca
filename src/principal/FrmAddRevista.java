 ...
 */
public class FrmAddRevista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Numero de Edicoes");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtNumEdicoes, javax.swing.GroupLayout.PREFERRED_SIZE, 309, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAddRevista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAddRevista("").setVisible(true);
            }
        });
    }
    ...
    private void salvarRevista() {
        ...
        if (txtNumEdicoes.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Aten��o: o campo número de edições é obrigatório!");
            return;
        }
