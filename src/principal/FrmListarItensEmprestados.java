...
public class FrmListarItensEmprestados extends javax.swing.JFrame {
    ...
    public FrmListarItensEmprestados(String txt) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnExcluir.setText("Excluir da lista de emprestados");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmListarItensEmprestados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListarItensEmprestados("").setVisible(true);
            }
        });
    }
