...
public class FrmListarItensDisponiveisMenuEstudante extends javax.swing.JFrame {
    ...
    public FrmListarItensDisponiveisMenuEstudante(String txt) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmListarItensDisponiveisMenuEstudante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListarItensDisponiveisMenuEstudante("").setVisible(true);
            }
        });
    }
